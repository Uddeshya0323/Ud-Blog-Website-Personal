  ...
  return (
    <Modal modal={modal} setModal={setModal}>
      <section
        ...
        ${modal ? "visible opacity-100" : "invisible opacity-0"} mback`}
      >
        <button
        ...
        <div className="flex flex-col justify-center items-center gap-[3rem]">
          {signReq === "" ? (
            <>
              <h2 className="text-2xl pt-[5rem]">
                {createUser ? "Join Uddeshya Tech" : "Welcome Back"}
              </h2>
          ...
          <p className="md:w-[30rem] mx-auto text-center text-sm mb-[3rem]">
            Click “Sign In” to agree to UddeshyaTerms of Service and acknowledge
            that Uddeshya Privacy Policy applies to you.
          </p>
        </div>
      </section>
    </Modal>
